...
func TestProblemCountSet(t *testing.T) {
	...
	aa := ProblemCountSet(14, "accepted\":1,\"fail_num\":3,\"wrong_answer\":1,\"compilation_error\":1,\"time_limit_exceeded\":5,\"memory_limit_exceeded\":1,\"output_limit_exceeded\":1,\"runtime_error\":3,\"system_error\":2}")
	fmt.Println(aa)
}
